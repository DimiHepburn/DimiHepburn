...
![Profile Views](https://komarev.com/ghpvc/?username=DimiHepburn&color=00d9ff&style=flat-square)
...
- 📐 Authored a **tetrad of frameworks** for human-centred AI — Friction Protocol, Humanising Loop, Attunement Audit, and Handoff Threshold
...
![Anthropic](https://img.shields.io/badge/Anthropic_API-D4A27F?style=for-the-badge)
...
| 🧠 [neuro-ai-bridge](https://github.com/DimiHepburn/neuro-ai-bridge) | Mapping neuroscientific principles onto deep learning architectures — Hebbian learning, SNNs, predictive processing, hippocampal memory | 🔧 Active research |
| 🤝 [humanising-ai](https://github.com/DimiHepburn/humanising-ai) | A tetrad of frameworks for emotionally intelligent, human-centred AI — Friction Protocol, Humanising Loop, Attunement Audit, Handoff Threshold — with reference implementation across affective, theory-of-mind, dialogue, and explainability modules | 🔧 Active research |
| 🔍 [llm-interpretability-notes](https://github.com/DimiHepburn/llm-interpretability-notes) | Research notes and experiments on mechanistic interpretability of LLMs — residual stream, attention circuits, SAEs, activation patching | 🔧 In progress |
...
- **`neuro-ai-bridge`** — *what brains do* → biological learning mechanisms as inductive bias for AI
- **`llm-interpretability-notes`** — *what models do* → reverse-engineering the internal computations of transformers
- **`humanising-ai`** — *what models should do* → frameworks and implementations for AI that behaves in a way that is legible, attuned, and safely bounded
...
![Dimi's GitHub stats](https://github-readme-stats.vercel.app/api?username=DimiHepburn&show_icons=true&theme=tokyonight&hide_border=true)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=DimiHepburn&layout=compact&theme=tokyonight&hide_border=true)
